...
const network_module: Module<NetworkState, RootState> = {
    ...
    actions: {
        ...
        async setNetwork({ state, dispatch, commit, rootState }, net: AvaNetwork) {
            ...
            // let chainIdP = await infoApi.getBlockchainID('P') // todo-lirax fix unnecessary requests to the api for lirax
            // let chainIdC = await infoApi.getBlockchainID('C') // probably remove these entirely
        ...
        async init({ state, commit, dispatch }) {
            ...
            let manhattan = new AvaNetwork(
                'Mainnet',
                'https://liraxapi.lirax.app:443',
                6,
                'https://explorerapi.lirax.app',
                'https://explorerapi.lirax.app',
                true
            )
