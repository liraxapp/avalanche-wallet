<template>
    <div>
        <div class="input_cont">
            <label>Title</label>
            <input @input="onInput" class="text" max="128" v-model="title" />
        </div>
        <div class="input_cont">
            <label>Image URL*</label>
            <input @input="onInput" class="text" placeholder="https://" v-model="imgUrl" />
        </div>
        <div class="input_cont">
            <label>Description</label>
            <textarea @input="onInput" class="text" maxlength="256" v-model="description" />
        </div>
        <!--        <div class="input_cont">-->
