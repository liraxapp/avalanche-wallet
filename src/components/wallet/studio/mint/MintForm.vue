    ...
    <div class="mint_form">
        <div class="cols">
            <div class="utxo_col">
                <div class="utxo">
                    <div>
                        <v-btn @click="clearUtxo" block text>Change Family</v-btn>
            ...
            <div class="type_col">
                <div class="type_sel">
                    ...
                    <v-chip-group mandatory v-model="nftFormType">
                        <v-chip :disabled="isSuccess" value="generic">Generic</v-chip>
                        <v-chip :disabled="isSuccess" value="custom">Custom</v-chip>
                    </v-chip-group>
            ...
            <div class="form_col">
                <template>
                    <div class="form_cont">
                        ...
                        ></Component>
                        <GenericForm @onInput="onInput" v-else></GenericForm>
                    </div>
                    <div>
                        <label>Quantity</label>
                        <input min="1" style="width: 100%" type="number" v-model="quantity" />
                    </div>
                    <div class="fee">
                        <p>
                            Fee
                            <span>{{ txFee.toLocaleString() }} LIRAX</span>
                        </p>
                    </div>
                    <v-btn
                        :disabled="!canSubmit"
            ...
            <div class="right_col">
                ...
                <template v-if="isSuccess">
                    <div class="success_cont">
                        ...
                        <v-btn @click="clearUtxo" class="button_secondary" depressed small>
                            Back to Studio
                        </v-btn>
                    </div>
                </template>
