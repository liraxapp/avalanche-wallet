    ...
    <div class="new_family">
        <div>
            ...
            <form @submit.prevent="submit" v-if="!isSuccess">
                ...
                <div>
                    <p>Fee: {{ txFee.toLocaleString() }} LIRAX</p>
                </div>
                <p class="err" v-if="error">{{ error }}</p>
                <v-btn :loading="isLoading" class="button_secondary" small type="submit">
                    Create
                </v-btn>
            </form>
            <div class="success_cont" v-if="isSuccess">
                ...
                <v-btn @click="cancel" class="button_secondary" depressed small>
                    Back to Studio
                </v-btn>
            </div>
        </div>
