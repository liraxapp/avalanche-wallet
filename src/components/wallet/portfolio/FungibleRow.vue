<template>
    <div class="asset">
        <div class="icon">
            <hexagon :is-ava="isAvaxToken" class="hex_bg"></hexagon>
            <div class="icon_img">
        ...
        <router-link :to="sendLink" class="send_col" v-if="isBalance">
            <img src="@/assets/sidebar/transfer_nav.png" v-if="$root.theme === 'day'" />
            <img src="@/assets/sidebar/transfer_nav_night.svg" v-else />
        </router-link>
        <p v-else></p>
