<template>
    <div :selected="is_default" class="addressItem">
        <ExportKeys
            :wallets="[wallet]"
            ref="export_wallet"
        ...
        <div class="rows">
            <div class="header">
                ...
                <template v-else>
                    <img
                        ...
                        v-if="$root.theme === 'day'"
                    />
                    <img class="key_logo" src="@/assets/key_inactive_night.png" v-else />
                </template>
                <div class="header_cols">
                    ...
                    <div class="buts">
                        <button @click="select" class="selBut" v-if="!is_default">
                        ...
                        <button @click="showModal" v-if="walletType == 'mnemonic'">
                            {{ $t('keys.view_key') }}
                        </button>
                        <button @click="showPrivateKeyModal" v-if="walletType == 'singleton'">
            ...
            <div class="header">
                <div></div>
                <div>
                    <p class="balance_empty" v-if="Object.keys(balances).length === 0">
                        {{ $t('keys.empty') }}
                    </p>
                    <div class="addressBalance bal_cols" v-else>
                        <p>This key has:</p>
                        <div class="bal_rows">
                            <p :key="bal.id" v-for="bal in balances">
                                {{ bal.toString() }}
                                <b>{{ bal.symbol }}</b>
                            </p>
                        </div>
