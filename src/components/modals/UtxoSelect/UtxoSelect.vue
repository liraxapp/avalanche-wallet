<template>
    <modal :title="$t('modal.utxo_select.title')" class="modal_main" ref="modal">
        <div class="utxo_select_modal_body">
            ...
            <div class="tot">
                ...
                <p>{{ selectedBalanceText }} LIRAX</p>
            </div>
            <v-btn @click="close" block class="button_secondary" depressed small>
