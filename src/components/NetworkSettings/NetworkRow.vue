<template>
    <div :active="isSelected" class="network_row">
        <div class="name_col">
            ...
            <div class="buts" v-if="!isSelected && !network.readonly">
                <button @click="edit" class="editBut">
                    <fa icon="cog"></fa>
                    {{ $t('network.row.edit') }}
                </button>
                <button @click="deleteNet" class="editBut">
                    <fa icon="trash"></fa>
        ...
        <div class="stat_col">
            ...
            <button class="connecting" v-else-if="!isConnected">
                {{ $t('network.status1') }}
            </button>
