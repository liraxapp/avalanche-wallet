<template>
    ...
    >
        <div :testnet="isTestnet" @click="toggleMenu" class="toggle_but">
            <template v-if="status === 'disconnected' || status === 'connecting'">
                <img src="@/assets/network_off.png" v-if="$root.theme === 'day'" />
                <img src="@/assets/network_off_night.svg" v-else />
            </template>
            <template v-else>
                <img src="@/assets/network_on.png" v-if="$root.theme === 'day'" />
                <img src="@/assets/network_off_night.svg" v-else />
            </template>
        ...
        <transition-group name="fade">
            <div @click="closeMenu" class="network_dispose_bg" key="bg" v-if="isActive"></div>
            <div class="network_body" key="body" v-if="isActive">
                ...
                <transition mode="out-in" name="fade">
                    ...
                    <CustomPage @add="addCustomNetwork" v-if="page === 'custom'"></CustomPage>
                    <EditPage
                        :net="editNetwork"
...
export default class NetworkMenu extends Vue {
    ...
    get isTestnet(): boolean {
        ...
        if (!net) return false
        if (net.networkId !== 6) return true
        return false
    }
