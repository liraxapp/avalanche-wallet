<template>
    <Component :is="viewer" :payload="payload" class="nft_payload_view" v-if="!small"></Component>
    <Component :is="viewerSmall" :payload="payload" class="nft_payload_view" v-else></Component>
</template>
<script lang="ts">
